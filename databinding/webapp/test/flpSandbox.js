		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DataBinding",
									"targetURL": "#sapbtpdatabinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpdatabinding-display": {
								"semanticObject": "sapbtpdatabinding",
								"action": "display",
								"description": "Data Binding Tutorial",
								"title": "DataBinding",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.databinding",
									"url": sap.ui.require.toUrl("sap/btp/databinding")
								}
							}
						}
					}
